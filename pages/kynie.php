	...
	<div class="wrapper">
		<div class="two-blocks">
			<div class="left-block">
				...
				?>
					<ul class="menu">
						...
						<a href="kynie.php"><li class="list-menu active">куньи</li></a>
			...
			<div class="right-block">
				<div class="header" style="background: url(../img/pictures/Куньи/Куньи.jpg) 100% 100%">
					<div class="content-top">
						<div><a href="../index.php" class="name-site">ЭкZoo</a></div>
					</div>
					<div class="content-bottom">
						<h1 class="detachment__title">Отряд Куньи</h1>
						<h2 class="detachment-info detachment-info__title">Куньи, или куницеобразные, — семейство млекопитающих отряда хищных. Являются одним из наиболее богатых видами семейств. Размеры куньих для хищников довольно малы. К куньим относятся куницы, норки, выдры, барсуки, хорьки и другие.</h2>
					</div>
				</div>
				<div class="content">
					<div class="content-text name-class_title">Представители куньих.</div>
						<?php
							require_once('../PHP/connect.php');
							$animalsInfo = get_animals_kyn();
