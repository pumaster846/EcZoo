...
<head>
	...
	<title>ЭкZoo - Отряд Рептилии</title>
</head>
<body>
	<div class="wrapper">
		<div class="two-blocks">
			<div class="left-block">
				...
				?>
					<ul class="menu">
						...
						<a href="reptiles.php"><li class="list-menu active">рептилии</li></a>
			...
			<div class="right-block">
				<div class="header" style="background: url(../img/pictures/Рептилии/Рептилии.jpg) 100% 100%">
					<div class="content-top">
						<div><a href="../index.php" class="name-site">ЭкZoo</a></div>
					</div>
					<div class="content-bottom">
						<h1 class="detachment__title">Отряд Рептилии</h1>
						<h2 class="detachment-info detachment-info__title">Пресмыкающиеся, или рептилии, — класс преимущественно наземных позвоночных животных из клады амниот, включающий современных черепах, крокодилов, клювоголовых и чешуйчатых.</h2>
					</div>
				</div>
				<div class="content">
					<div class="content-text name-class_title">Представители рептилий.</div>
						<?php
							require_once('../PHP/connect.php');
							$animalsInfo = get_animals_rep();
