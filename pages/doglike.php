...
<head>
	...
	<title>ЭкZoo - Отряд Псовые</title>
</head>
<body>
	<div class="wrapper">
		<div class="two-blocks">
			<div class="left-block">
				...
				?>
					<ul class="menu">
						...
						<a href="doglike.php"><li class="list-menu active">псовые</li></a>
			...
			<div class="right-block">
				<div class="header" style="background: url(../img/pictures/Псовые/Псовые.jpg) 100% 100%">
					<div class="content-top">
						<div><a href="../index.php" class="name-site">ЭкZoo</a></div>
					</div>
					<div class="content-bottom">
						<h1 class="detachment__title">Отряд Псовые</h1>
						<h2 class="detachment-info detachment-info__title">Псовые, или собачьи, или волчьи, или собаки, или каниды, — семейство млекопитающих отряда хищных, включающее в себя ныне три подсемейства: волчьи, собачьи и большеухие лисицы.</h2>
					</div>
				</div>
				<div class="content">
					<div class="content-text name-class_title">Представители псовых.</div>
						<?php
							require_once('../PHP/connect.php');
							$animalsInfo = get_animals_dog();
