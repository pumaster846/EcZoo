...
<head>
	...
	<title>ЭкZoo - Отряд Рукокрылые</title>
</head>
<body>
	<div class="wrapper">
		<div class="two-blocks">
			<div class="left-block">
				...
				?>
					<ul class="menu">
						...
						<a href="cheiroptera.php"><li class="list-menu active">рукокрылые</li></a>
			...
			<div class="right-block">
				<div class="header" style="background: url(../img/pictures/Рукокрылые/Рукокрылые.jpg) 100% 100%">
					<div class="content-top">
						<div><a href="../index.php" class="name-site">ЭкZoo</a></div>
					</div>
					<div class="content-bottom">
						<h1 class="detachment__title">Отряд Рукокрылые</h1>
						<h2 class="detachment-info detachment-info__title">Рукокрылые ( Chiroptera) — отряд плацентарных млекопитающих, единственный, представители которого способны к активному полёту. Это второй по величине отряд млекопитающих, включает в себя 1350 видов. Рукокрылые чрезвычайно разнообразны, они населяют все континенты Земли, за исключением Антарктиды.</h2>
					</div>
				</div>
				<div class="content">
					<div class="content-text name-class_title">Представители рукокрылых.</div>
						<?php
							require_once('../PHP/connect.php');
							$animalsInfo = get_animals_cheiro();
