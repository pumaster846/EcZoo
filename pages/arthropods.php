...
<head>
	...
	<title>ЭкZoo - Отряд Насекомые</title>
</head>
<body>
	<div class="wrapper">
			...
			<div class="left-block">
				...
				?>
					<ul class="menu">
						...
						<a href="arthropods.php"><li class="list-menu active">насекомые</li></a>
						<a href="../PHP/find.php"><li class="list-menu serch-animals"><i class="fa fa-search"></i>поиск</li></a>
					</ul>
				</div>
			</div>
			<div class="right-block">
				<div class="header" style="background: url(../img/pictures/Насекомые/Насекомые.jpg) 100% 100%">
					<div class="content-top">
						<div><a href="../index.php" class="name-site">ЭкZoo</a></div>
					</div>
					<div class="content-bottom">
						<h1 class="detachment__title">Отряд Насекомые</h1>
						<h2 class="detachment-info detachment-info__title">Насекомые — тип первичноротых животных, включающий насекомых, ракообразных, паукообразных и многоножек. По количеству видов и распространённости может считаться самой процветающей группой живых организмов.</h2>
					</div>
				</div>
				<div class="content">
					<div class="content-text name-class_title">Представители насекомых.</div>
						<?php
							require_once('../PHP/connect.php');
							$animalsInfo = get_animals_arh();
