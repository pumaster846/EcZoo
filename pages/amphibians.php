...
<head>
	...
	<title>ЭкZoo - Отряд Амфибии</title>
</head>
<body>
	<div class="wrapper">
		<div class="two-blocks">
			<div class="left-block">
				...
				?>
					<ul class="menu">
						...
						<a href="amphibians.php"><li class="list-menu active">амфибии</li></a>
			...
			<div class="right-block">
				<div class="header" style="background: url(../img/pictures/Амфибии/Амфибии.jpg) 100% 100%">
					<div class="content-top">
						<div><a href="../index.php" class="name-site">ЭкZoo</a></div>
					</div>
					<div class="content-bottom">
						<h1 class="detachment__title">Отряд Амфибии</h1>
						<h2 class="detachment-info detachment-info__title">Земноводные, или амфибии, — класс позвоночных четвероногих животных, в числе прочих включающий тритонов, саламандр, лягушек и червяг — всего более 8 319 современных видов, что делает этот класс сравнительно немногочисленным.</h2>
					</div>
				</div>
				<div class="content">
					<div class="content-text name-class_title">Представители амфибий.</div>
						<?php
							require_once('../PHP/connect.php');
							$animalsInfo = get_animals_amf();
