...
<head>
	...
	<title>ЭкZoo - Отряд Грызуны</title>
</head>
<body>
	<div class="wrapper">
		<div class="two-blocks">
			<div class="left-block">
				...
				?>
					<ul class="menu">
						...
						<a href="rodents.php"><li class="list-menu active">грызуны</li></a>
			...
			<div class="right-block">
				<div class="header" style="background: url(../img/pictures/Грызуны/Грызуны.jpg) 100% 100%">
					<div class="content-top">
						<div><a href="../index.php" class="name-site">ЭкZoo</a></div>
					</div>
					<div class="content-bottom">
						<h1 class="detachment__title">Отряд Грызуны</h1>
						<h2 class="detachment-info detachment-info__title">Грызуны — самый многочисленный отряд млекопитающих. По данным описано 2277 видов грызунов. Отличительным признаком представителей отряда является наличие диастемы и по одной паре крупных резцов в верхней и нижней челюстях.</h2>
					</div>
				</div>
				<div class="content">
					<div class="content-text name-class_title">Представители грызунов.</div>
						<?php
							require_once('../PHP/connect.php');
							$animalsInfo = get_animals_rod();
